...
{if isset($zm40_about_name) && $zm40_about_name}
    <div class="panel zm40-about">
        ...
        <div class="row">
            <div class="col-lg-9">
                <p>{$zm40_about_name|escape:'html':'UTF-8'} est un module <strong>libre et open source</strong>, distribué sous licence {if isset($zm40_about_license) && $zm40_about_license}{$zm40_about_license|escape:'html':'UTF-8'}{else}OSL 3.0{/if} : code source ouvert, auditable, modifiable et redistribuable, à condition d'en conserver la licence et de partager vos modifications.</p>
